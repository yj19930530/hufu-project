<template>
	<div class="water-item-content" @tap="openWecat">
		...
		<div class="water-item-describe">
			<div class="fz-15 box-heigth-style">
				<div class="text-lang-dian2">{{detailData.gtitle}}</div>
			</div>
			<div>
				<text class="fz-17 fw-bold fc-f1">¥{{detailData.bprice}}</text>
				<text v-if="detailData.price4" class="fz-14 fc-999 mr-l-20 text-through">¥{{detailData.price4}}</text>
			</div>
		</div>
	</div>
</template>
